#coded by RelGanz
"""Dilarang Recode Ya Bossq gw  Udh Cape2 Buat Tools Ini
gw Tau lu Bisa Buat Tools Sendiri, lu Anggap Ini Sampah
...
def info():
	print R+"<[=================================]>"
	print R+"<["+G+" Author : RelGanz           "+R+"]>"
	print R+"<["+G+" Youtube   : RelGanz        "+R+"]>"
	print R+"<[=================================]>"
